  ...
  return (
    <div className="bg-[#5BA7FF] pb-[40px] min-h-screen">
      ...
      <div className="ml-[20px] text-[#0070F0] lg:text-[40px] leading-normal lg:ml-[80px] font-pixelifySans text-justify w-[90%] flex justify-center">
        ...
        BASE ecosystem. Meme coins are often seen as a gateway for everyday
        people to enter the crypto space. BASE, as a new layer two scaling
        solution for Ethereum, is widely unknown to non-crypto native
        individuals. $CHUCK aims to boost interest and activity on BASE,
        increase participation on DEXes, increase TVL on the BASE platform, and,
        ultimately, support the vision of Brian Armstrong and the Coinbase team.
        Additionally, $CHUCK aims to create a Chuck Norris-themed ecosystem and
        community, where community members have an opportunity to engage with
        one another and create fun Chuck Norris-inspired NFT&apos;s, merchandise
        and games reflective of 1980&apos;s action films and retro gaming
      </div>
      ...
      <div className="ml-[20px] text-[#0070F0] lg:text-[40px] lg:ml-[80px] leading-normal font-pixelifySans text-justify w-[90%] flex justify-center">
        ...
        the $CHUCK token grants you access to the $CHUCK Telegram group and
        Chuck-Bot, a bot that grants community members access to valuable
        information within the cryptocurrency sector, such as trending coins and
        ETH gas fees. Ownership of $CHUCK token grants holders access to
        community-created NFT&apos;s, games and exclusive content. Additionally,
        $CHUCK aims to not only be a dog-themed meme coin, it aspires to
        actually benefit dogs. Every sale of $CHUCK will incur a 5% tax, a
        portion of which will be donated to Warrior Dog Foundation, a charitable
        organization designed to transition working K9&apos;s from an
        operational environment to retirement. While dog meme culture is
        pervasive in the crypto industry, $CHUCK is the first meme coin that
